...
public class Parameters 
{
	...
	public static void loadDGE(String[] args) throws Exception
	{
		...
		if(tmpFolder == null) 
		{
			System.out.println("No folder for temporary generated files is specified, using output folder as default: \""+outputFolder+"\". You can specify an temp folder by using the '-t' option.");
	...
	private static void printHelpDGE()
	{
		...
		System.out.println("-chunkSize %i\tMaximum number of reads to be stored in RAM (default = 10000000)");
	...
	{
		System.out.println("BRBseq-tools\n\nOptions:");
